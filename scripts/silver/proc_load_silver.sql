...
Script Purpose:
    This stored procedure loads transformed and cleansed data from the 'bronze'
    schema into the 'silver' schema.

    It performs the following actions:
    - Truncates the Silver tables before loading.
    - Cleans, standardizes, and transforms data from Bronze tables.
    - Removes duplicates where required.
    - Standardizes categorical values such as gender, marital status,
      product lines, countries, and maintenance indicators.
    - Handles invalid dates and missing values.
    - Calculates derived and corrected values where required.
    - Captures and prints the number of rows inserted for each table.
    - Measures and prints the duration of each loading step.
    - Measures and prints the total Silver loading duration.
    - Implements TRY...CATCH error handling and reports error details.
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            -- Handle invalid future birth dates
            CASE
                WHEN bdate > GETDATE()
                    THEN NULL
...
-- =========================================================
-- Execute Silver Loading Procedure
-- =========================================================
